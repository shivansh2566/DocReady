...
const PORTAL_LINKS = {
  ...
  ration:   {
    _default:    [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}],
    telangana:   [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}, {label:'MeeSeva (Telangana)', url:'https://meeseva.telangana.gov.in/'}],
    ap:          [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}, {label:'AP Food Portal (AePDS)', url:'https://ap.meeseva.gov.in/'}],
    maharashtra: [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}, {label:'Mahafood Portal', url:'https://rcms.mahafood.gov.in/'}],
    up:          [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}, {label:'UP Food Portal', url:'https://fcs.up.gov.in/'}],
    karnataka:   [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}, {label:'Ahara (Karnataka)', url:'https://ahara.kar.nic.in/'}],
    other:       [{label:'NFSA Portal', url:'https://nfsa.gov.in/'}],
  },
  voterid:  [{label:'Voter Portal (ECI)', url:'https://voters.eci.gov.in/'}],
  income:   {
    _default:    [{label:'ServicePlus / eDistrict', url:'https://serviceonline.gov.in/'}],
    telangana:   [{label:'MeeSeva (Telangana)', url:'https://meeseva.telangana.gov.in/'}],
    ap:          [{label:'AP MeeSeva', url:'https://ap.meeseva.gov.in/'}],
    maharashtra: [{label:'Aaple Sarkar Portal', url:'https://aaplesarkar.mahaonline.gov.in/'}],
    up:          [{label:'eDistrict UP', url:'https://edistrict.up.gov.in/'}],
    karnataka:   [{label:'Nadakacheri (Karnataka)', url:'https://nadakacheri.karnataka.gov.in/'}],
    other:       [{label:'ServicePlus / eDistrict', url:'https://serviceonline.gov.in/'}],
  },
  caste:    {
    _default:    [{label:'ServicePlus / eDistrict', url:'https://serviceonline.gov.in/'}],
    telangana:   [{label:'MeeSeva (Telangana)', url:'https://meeseva.telangana.gov.in/'}],
...
function renderOfficialLinks(svc) {
  ...
  if (!entry) {
    ...
    /* state-keyed object — pick state-specific or fall back to _default */
    var state = '';
    var stateEl = document.getElementById('stateSelect');
    if (stateEl) state = stateEl.value;
    links = entry[state] || entry['_default'] || [];
  }
...
function setLang(lang) {
  if (lang !== 'en') {
    var messages = {
      'hi': 'और भाषाएँ जल्द आएंगी! / More languages coming soon!',
      'te': 'త్వరలో మరిన్ని భాషలు వస్తాయి! / More languages coming soon!',
      'ta': 'விரைவில் மேலும் மொழிகள் வரும்! / More languages coming soon!'
    };
    showToast(messages[lang] || 'More languages coming soon!');
